...
class DataTrainingArguments:
    ...
    revision_name: Optional[str] = field(
        default="main", metadata={"help": "Revision name of the dataset"}
    )
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        raw_datasets = load_dataset(
            ...
            revision=data_args.revision_name,
    ...
    # Add the special tokens if necessary
    if not "<sp>" in tokenizer.get_vocab():
        tokenizer.add_special_tokens({"additional_special_tokens": ["<sp>", "</sp>"]})

    if model_args.model_name_or_path:
        model = BertForRuleScoring.from_pretrained(
        ...
        model = BertForRuleScoring.from_config(config)
